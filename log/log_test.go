...
func TestTryDeleteOldestFiles(t *testing.T) {
	...
	sysio.WriteDataToFile(path+"/ybfs-log.log_2018-12-30_11_55_20", []byte("hello"))
	sysio.WriteDataToFile(path+"/ybfs-log.log_2018-12-14_11_32_12", []byte("hello"))
	sysio.WriteDataToFile(path+"/ybfs-log.log_2018-12-14_11_22_12", []byte("hello"))
	sysio.WriteDataToFile(path+"/ybfs-log.log_2018-12-30_11_32_11", []byte("hello"))
	sysio.WriteDataToFile(path+"/ybfs-log.log_2018-12-11_11_32_11", []byte("hello"))
	sysio.WriteDataToFile(path+"/ybfs-log.log_2018-12-30_11_32_13", []byte("hello"))
